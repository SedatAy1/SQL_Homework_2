...
## 3-Sütunların her birine göre diğer sütunları güncelleyecek 5 adet UPDATE işlemi yapalım.
    UPDATE employee SET name = 'Ahmet' WHERE id = 8;
    UPDATE employee SET name = 'Mehmet' WHERE id = 12;
    UPDATE employee SET birthday = '1994-01-21' WHERE id = 19;
    UPDATE employee SET birthday = '1999-01-12' WHERE id = 14;
    UPDATE employee SET email = 'ay@sedat.co' WHERE id = 13;

    
## 4-Sütunların her birine göre ilgili satırı silecek 5 adet DELETE işlemi yapalım.    

    
    DELETE FROM employee WHERE birthday = '1964/12/23';
    DELETE FROM employee WHERE birthday = '2007/05/29';
    DELETE FROM employee WHERE email = 'rhouseago1j@e-recht24.de';
